...
---
## PS: My Future work: Will develop a UVM TB constrained-random verification by using my own AXI4-Lite VIP which is on my github [Here](https://github.com/ayengec/AXI4_Lite_VIP) 
